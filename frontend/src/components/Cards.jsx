        ...
        ${isSelected ? 'border-violet-500 shadow-lg shadow-violet-500/20 bg-violet-50'
            ...
            {thumbnailImg ? (
                <div className=" relative w-full h-full overflow-hidden">
                    <img src={thumbnailImg || '/placeholder.svg'} alt="Template review" className=" w-fulln h-full 
                    ...
                    {/* Hover effect */}
                    <div className=" absolute inset-0 bg-gradient-to-t from bg-violet-100/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    </div>
                </div>
            ) : (
