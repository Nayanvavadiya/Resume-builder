...
import { CloudSnow, Download, Loader2, Palette, Save, Trash2 } from 'lucide-react'
...
const EditResume = () => {
    ...
    // Take back to Previous form state or take back to first or /Dashbaord
    const goBack = () => {
        const pages = [
            "profile-info",
            "contact-info",
    ...
    //Update array intems state using index
    ...
    //fetching the resume details by using backend url 
    ...
    //This fuction will help in updating the resumes. and put will help in updation on backend..
    const updateResumeDetails = async (thumbnailLink = null) => {
        try {
            setIsLoading(true)
            ...
            <div className={containerStyles.main}>
                <div className={containerStyles.header}>
                    <TitleInput title={resumeData.title}
                        ...
                        onSave={() => updateResumeDetails(resumeData.thumbnailLink)}
                    />
