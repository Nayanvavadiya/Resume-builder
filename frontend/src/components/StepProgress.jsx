    ...
    return (
        <>
            ...
            <div className=' relative w-full h-4 bg-white/5 backdrop-blur-2xl overflow-hidden rounded-full border border-white/10'>
                ...
                animate-flow bg-[length:200_100%] transition-all duration-700 ease-out rounded-full overflow-hidden
            ...
            <div className=' flex justify-between items-center mt-3'>
                ...
                <div className=' flex items-center gap-2'>
                    {progress === 100 && (
                        <div className=' w-6 h-6 bg-gradient-to-r from-gray-500 to-emerald-500 rounded-full 
